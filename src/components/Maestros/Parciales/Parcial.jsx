...
export default function Parcial({ parciales,materia }) {
  const { Titulo, parcial } = parciales;

  return (
    <div className=" w-full mt-4 lg:mt-5">
      <Link
        to={`/maestro/tareas/${parcial}/${materia}`}
        className="block max-w-sm p-6 w-[20rem] bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
      >
